    ...
    <form id="submitAnswer" action="{{ route('chinese.answer') }}" method="post">
        ...
        <div class="flex flex-col">
            <input type="number" id="yoursisheng"
                class="my-1 border-none bg-blue-100 outline outline-3 outline-blue-200"name="yoursisheng"
                placeholder="声調を入力" value="{{ old('yoursisheng', '') }}" />
            <input type="text" id="yourpinyin"
                class="my-1 border-none bg-blue-100 outline outline-3 outline-blue-200" name="yourpinyin"
                placeholder="ピンインを入力"value="{{ old('yourpinin', '') }}" />

        </div>

        <p id='sisheng_pinyin' class="text-xl border-b-4" aria-placeholder=""></p>
