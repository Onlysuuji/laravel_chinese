<x-test2-layout>
    ...
    <div class="flex flex-col justify-center items-center gap-y-6 my-4" x-data="getQueryParams">
        <div class="space-x-4">
            ...
            <a @click="sort = 'created_at'" :href="'{{ route('chinese.wordlist') }}?sort=' + sort + '&order=' + order"
                class="px-4 py-2 text-white rounded text-shadow-md shadow" :disabled="true"
    ...
    <div class="grip place-content-center md:flex md:justify-center">
        <div class="px-10 w-[755px] md:w-[1200px]">
            <div
                class="block md:w-full border-4 border-black ring-2 ring-black ring-offset-2 ring-offset-rose-800">
                <div></div>
