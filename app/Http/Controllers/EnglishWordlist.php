...
use App\Models\English;  // 必要に応じてモデルを指定
use App\Models\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Php;

class EnglishWordlist extends Controller
{
    public function wordlist(Request $request)
    {
        ...
        $words = English::where('user_id', Auth::id())
        ...
        return view('english.wordlist', compact('words','sort', 'order', 'searchKeyword'));
    }
}
